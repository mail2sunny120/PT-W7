...
public class ProjectDao extends DaoBase {
	...
	//modifyProjectDetails added by Sunil on 20 Apr 24
	// for week 11 assignment
	// input: project record
	
	//Objective is to update an existing project record
	//fields updated: project_name, estimated_hours, actual_hours
	//				  difficulty, notes
	...
	//deleteProject added by Sunil on 20 Apr 24
	//for week 11 assignment
	
	// input: projectId
	//Objective is to delete an existing project record
	...
	public boolean deleteProject(Integer projectId) {
		...
		try(Connection conn = DbConnection.getConnection()) {
			...
			try(PreparedStatement stmt = conn.prepareStatement(sql)) {
				...
				rollbackTransaction(conn);
				System.out.println("ProjectId is invalid"+ projectId);
				throw new DBException(e);
			}
			}
		catch(SQLException e) {
